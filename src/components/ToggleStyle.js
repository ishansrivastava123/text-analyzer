...
export default function ToggleStyle(props) {
    ...
    const styles = ({
        border: props.mode === "dark" ? "1.5px solid white" : "1px solid #222",
  ...
  return (
    <div>
        <h1 style={styles}>This text is just to highlight the Light/Dark mode feature</h1>
        <div className="accordion" id="accordionExample">
            ...
            <div className="accordion-item">
                ...
                <div style={styles} className="accordion-body">
